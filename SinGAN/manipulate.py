...
def SinGAN_generate(Gs,Zs,reals,NoiseAmp,opt,segmap,in_s=None,scale_v=1,scale_h=1,n=0,gen_start_scale=0,num_samples=50):
    ...
    for G,Z_opt,noise_amp in zip(Gs,Zs,NoiseAmp):
        ...
        for i in range(0,num_samples,1):
            ...
            z_in = noise_amp*(z_curr)+I_prev
            I_curr = G(z_in.detach(),I_prev,segmap)
